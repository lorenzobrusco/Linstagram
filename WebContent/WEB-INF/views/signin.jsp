					...
					<div class="login-form">
						<form class="sign-in-htm" action="signInAttempt" method="post">
							<div class="group">
								...
								<input id="user-singin" name="username" type="text" class="input"
									required>
							</div>
							<div class="group">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		function buildNoty(customtext){
			var notyconf= {
					text: '<p style="color:black;font-weight:bold;text-transform: uppercase;">Operation Failed!</p>'+customtext+' !',
					theme: 'nest',
					type: 'error',
					layout: 'bottomLeft',
					timeout:4000,
